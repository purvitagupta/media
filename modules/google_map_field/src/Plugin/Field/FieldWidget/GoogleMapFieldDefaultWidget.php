...
class GoogleMapFieldDefaultWidget extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
	...
	$element['marktitle'] = [
	      ...
	      '#size' => 32,
	      '#type' => 'textfield',
	      '#default_value' => isset($items[$delta]->marktitle) ? $items[$delta]->marktitle : NULL,
	      '#attributes' => [
	        'data-marktitle-delta' => $instance_delta,
	      ],
	    ];
	$element['marktext'] = [
	      '#title' => $this->t('Marker Text'),
	      '#type' => 'textarea',
	      '#default_value' => isset($items[$delta]->marktext) ? $items[$delta]->marktext : NULL,
	      '#attributes' => [
	        'data-marktext-delta' => $instance_delta,
	      ],
	    ];
	  $element['markcolor'] = [
	      ...
	      '#size' => 32,
	      '#type' => 'textfield',
	      '#default_value' => isset($items[$delta]->markcolor) ? $items[$delta]->markcolor : NULL,
	      '#attributes' => [
	        'data-markcolor-delta' => $instance_delta,
	      ],
	    ];
