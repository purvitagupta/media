...
class GoogleMapFieldType extends FieldItemBase {
  ...
  public static function propertyDefinitions(FieldStorageDefinitionInterface $field_definition) {
    $properties['name'] = DataDefinition::create('string')
      ...
      $properties['marktitle'] = DataDefinition::create('string')
      ->setLabel(new TranslatableMarkup('Map Title'));
      $properties['marktext'] = DataDefinition::create('string')
      ->setLabel(new TranslatableMarkup('Map Text'));
      $properties['markcolor'] = DataDefinition::create('string')
      ->setLabel(new TranslatableMarkup('Map Color'));
