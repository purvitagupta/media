...
namespace Drupal\presenter\Plugin\Field\FieldType;
 ...
 *     default_formatter = "presenter_default",
 *     default_widget = "presenter_default"
 * )
 */

class Presenters extends FieldItemBase {
