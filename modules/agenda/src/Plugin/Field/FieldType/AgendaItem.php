<?php
namespace Drupal\agenda\Plugin\Field\FieldType;
 ...
 *     default_formatter = "agenda_default",
 *     default_widget = "agenda_default"
 * )
 */
class AgendaItem extends FieldItemBase {
    /**
